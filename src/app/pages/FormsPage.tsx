...
export default function FormPage() {
  ...
  <div className="w-[39%] portrait:w-full    px-[4vw] py-[2vw]  rounded-[1vw] shadow-md">
      ...
      <div className="mb-[1vw] ">
        <Link href="/" className="text-[#e0c08c] hover:text-[#FAF5E5]  transition-colors cursor-pointer portrait:text-[1.8vw] portrait:sm:text-[1.3vw]">
          ← Back to Home
        </Link>
        <h1 className="text-[1vw] portrait:text-[1.4vw] portrait:sm:text-[1.2vw] font-bold text-[#828282] mt-[0.2vw]">Describe Section</h1>
      </div>
      ...
      <div className="space-y-[2vw]">
        ...
        <div className="border-b pb-[1vw]">
          <h2 className="text-[2vw]  portrait:text-[4vw]  portrait:sm:text-[3.4vw] font-semibold text-[#1F0954] mb-[1vw]">Program Information</h2>
          <div className="space-y-[1vw]">
            <h2 className="text-[1vw] portrait:text-[1.8vw] portrait:sm:text-[2vw] font-semibold text-[#1F0954]">Title</h2>
            <input
              type="text"
              placeholder="Describe Section Title e.g. What you stand to learn"
              className="w-full h-[3vw] portrait:h-[4vw] portrait:sm:h-[3vw]  p-[0.4vw] portrait:p-[.6vw] border rounded-[0.4vw] focus:ring-[0.2vw] focus:ring-[#f3c49a] text-[1vw] portrait:text-[2vw]  portrait:sm:text-[2.1vw]  "
              value={sectionTitle}
              onChange={(e) => setSectionTitle(e.target.value)}
            />
            <div className="flex gap-[2vw] portrait:text-[1.2vw] portrait:sm:text-[1.2vw]">
        ...
        <div className="border-b pb-[1vw]">
          <div className="space-y-[1vw]">
            <h2 className="text-[1vw] portrait:text-[1.8vw]  portrait:sm:text-[2vw]  font-semibold text-[#1F0954]">Description</h2>
            <textarea
              placeholder="Provide a clear and concise description/information of your program..."
              className="w-full h-[8vw] portrait:h-[16vw] portrait:sm:h-[8vw]  portrait:p-[.6vw] p-[0.4vw] border rounded-[0.4vw] focus:ring-[0.2vw] focus:ring-[#f3c49a] text-[1vw] portrait:text-[2vw]  portrait:sm:text-[1.8vw]  "
              value={description}
        ...
        <div className="border-b pb-[1vw]">
          <div className="space-y-[1vw]">
            <div className="flex items-center justify-between bg-gray-50 pl-[1vw] py-[1vw] rounded-[0.4vw]">
              <span className="text-[1vw]  portrait:text-[2vw]  portrait:sm:text-[2.1vw]   text-gray-600">(maximum number of sections is 3)</span>
              <button
                onClick={addSection}
                disabled={sections.length >= 3}
                className={`px-[1.3vw] py-[1vw] rounded-[0.4vw] portrait:text-[2vw]  portrait:sm:text-[1.8vw]   ${sections.length >= 3 ? 'bg-gray-300' : 'bg-[#1F0954] text-[#FAF5E5] hover:bg-[#2A0B6E]'}`}
              >
                Add a Section
              </button>
            </div>
            <div className="flex items-center gap-[1vw] text-[1vw] portrait:text-[2.1vw]  portrait:sm:text-[1.3vw]   text-gray-600">
...
<div className="profile-image w-[2vw] h-[2vw] portrait:w-[5vw] portrait:h-[5vw] portrait:sm:w-[4vw] portrait:sm:h-[4vw]   rounded-full bg-[#3c4d3d] relative flex ">
  <Image src={profileIMG} alt="profile image" layout="fill" objectFit="cover" quality={100} className="rounded-full "/>
  </div>
  <div className="name-title-div flex flex-col text-[0.8vw] portrait:text-[2vw] portrait:sm:text-[1.4vw]">
<span className="name  ">Godwin Jimmy</span>
<div className="title text-[0.6vw] portrait:text-[1.4vw] portrait:sm:text-[1vw] text-[#777795FE]">Free Plan <span className=' text-[#2B85FE]'>Upgrade</span></div>


</div>
</div>

<Image src={downArrow} alt="arrow"  quality={100} className="rounded-full w-[0.8vw] h-[0.6vw]  portrait:w-[2.4vw] portrait:h-[1.4vw] portrait:sm:w-[1.2vw] portrait:sm:h-[.8vw] "/>
