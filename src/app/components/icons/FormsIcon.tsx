...
const SvgComponent: React.FC<SvgComponentProps> = ({
  ...
  >
    <path
      ...
      clipRule="evenodd"
    />
    <path fill={fill} d="M12 75.556h64v4.888H12v-4.888ZM12 65.778h64v4.889H12v-4.89Z" />
    <path
      fill={fill}
      d="M58.617 50.053 94.346.316a.4.4 0 0 1 .549-.098l4.765 3.225a.4.4 0 0 1 .101.564l-35.714 49.72-5.429-3.674ZM52 60.402l6.577-9.02 3.912 2.688-6.577 9.019-3.6.911L52 60.402Z"
    />
  </svg>
);
