    ...
    <>
      ...
      <div
        className={`sidebar-entrance-handle  landscape:hidden rounded-r-sm z-50 overflow-hidden cursor-pointer
                   ...
                   hover:backdrop-blur-sm  ${isOpened? 'bg-[#431e98d2]' : 'bg-[#240e55]' } fixed left-0 top-0 h-[6vw] w-[6vw] grid place-content-center`}
      ...
      {/* Sidebar */}
      <aside
  className={`group fixed  left-0 top-0 h-full transition-all duration-300 portrait:pl-[4vw]
