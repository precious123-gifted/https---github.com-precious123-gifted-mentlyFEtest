    ...
    <nav className="flex h-full flex-col justify-between text-[#FAF5E5] group">
      <div className="flex flex-col">
        ...
        <div className="flex flex-col space-y-[1.25vw]">
          <NavItem icon={<DashboardIcon className="icon-pop-down" />} label="Dashboard" />
          <NavItem icon={<AnalyticsIcon className="icon-pop-down" />} label="Analytics" />
          <NavItem icon={<ProgramsIcon className="icon-pop-down" />} label="Programs" />
          <NavItem icon={<ActivitiesIcon className="icon-pop-down" />} label="Activities" />
          <NavItem icon={<FormsIcon className="icon-pop-down" />} label="Forms" />
          <NavItem icon={<FinanceIcon className="icon-pop-down" />} label="Finances" />
          <NavItem icon={<BadgesIcon className="icon-pop-down" />} label="Badges" />
          <NavItem icon={<SettingsIcon className="icon-pop-down" />} label="Settings" />
          <NavItem icon={<LogoutIcon className="icon-pop-down" />} label="Logout" />
        </div>
      </div>
